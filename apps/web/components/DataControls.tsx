...
export type PrivacyState = {notice_version:string; acknowledged:boolean; research_opt_in:boolean; last_erased_at:string|null; deletion_request:{id:string;status:string;created_at:string;completed_at:string|null}|null};

export function DataNotice() {
  return <><p>ThinkFirst saves your questions, attempts, AI replies, feedback, and activity times to your account. When you ask AI, the relevant conversation is sent to an AI service. Automatic fallback may send that context to another configured service.</p><p>Research sharing is optional and off by default. Turning it on includes your saved conversations and future activity in research exports, including written attempts and reflections. You can turn it off at any time for future exports. Previously downloaded copies cannot be recalled automatically.</p><p>Conversations stay until you request deletion in Settings. Deletion needs operator processing; account and usage records remain. Avoid entering sensitive personal information. Drafts are stored on this device, so use your own browser profile on shared computers.</p></>;
}
