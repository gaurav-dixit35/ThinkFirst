...
export type SessionData = {archived?:boolean;deletion_pending?:boolean;answer_style?:'concise'|'detailed';id: string; status: string; events: LogEvent[]; summary: Record<string, any>; experience?:'chat'|'guided'; mode?:ConversationMode; practice?:PracticeState;title?:string;custom_title?:boolean;overview?:ConversationOverview};
